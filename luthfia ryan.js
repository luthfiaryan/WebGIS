...
<body>
      ...
      <article class="col-md-6 mb-4">
        ...
        <div class="semi-bold">
          <p class="text-justify">
            Salah satu mata kuliah dalam Kelompok Bidang Keahlian (KBK) Sistem Informasi Geografis (SIG) adalah SIG Berbasis Internet. 
            Mata kuliah ini membahas penerapan SIG melalui platform internet, termasuk pemahaman konsep kerja internet, proses permintaan (request) dan tanggapan (response) antara pengguna dan server, serta pembangunan website untuk mendukung pengaplikasian SIG tersebut.
          </p>
          <p class="text-justify">
            Memahami HTML dan CSS merupakan langkah lanjutan dalam pembuatan halaman website. 
            Salah satu tugas pada tahap ini adalah membangun tampilan halaman web sederhana, yang kemudian dikembangkan lebih lanjut dengan menerapkan Bootstrap.
          </p>
        </div>
      </article>
  ...
  <div class="container my-4 content-page" id="petaContent">
    ...
    <div class="semi-bold">  
      <h4>Peta Statis</h4>
      <p class="text-justify">
        Ciri-ciri Peta Statis yaitu disajikan dalam bentuk tetap (cetak atau digital) sehingga tidak dapat diperbesar, diperkecil, atau dipindahkan secara interaktif. 
        Selain itu, informasi yang ditampilkan bersifat final dan tidak bisa diperbarui secara real-time.
        Peta statis mudah diakses dan dibagikan, terutama dalam bentuk cetak dan tidak memerlukan perangkat khusus atau koneksi internet untuk digunakan.
        Namun informasi terbatas, hanya menampilkan data yang sudah ditentukan sebelumnya dan sulit untuk diperbarui karena perlu dicetak atau dibuat ulang jika ada perubahan.     
        Sehingga kurang fleksibel karena tidak bisa disesuaikan dengan kebutuhan pengguna secara dinamis.
      <p class="text-justify">
      </p>
      ...
      <h4>Peta Dinamis</h4>
      <p class="text-justify">
        Peta dinamis adalah peta digital yang menampilkan elemen-elemen yang dapat berubah secara otomatis. 
        Meskipun tidak bersifat interaktif, peta dinamis mampu memperlihatkan perubahan informasi dari waktu ke waktu, seperti visualisasi cuaca, lalu lintas, atau perkembangan wilayah. 
        Kelebihannya terletak pada kemampuannya menyajikan data terkini dan memudahkan pemahaman pola perubahan secara visual. 
        Namun, peta dinamis memerlukan perangkat digital dan sering kali membutuhkan koneksi internet sehingga bergantung pada sistem pembaruan data yang akurat.
      </p>
      <div class="map-container mb-4">
      </div>
  ...
  <div class="container my-4 content-page" id="contohPetaContent">
    ...
    <div class="semi-bold">
      ...
      <div class="map-container mb-4">
        <img src== "https://bapperida.jogjaprov.go.id/download/download/498">
      </div>
      <h4>Contoh Peta Dinamis</h4>
      <div class="map-container mb-4">
        <img src="https://bapperida.jogjaprov.go.id/download/download/500" alt="Contoh Peta Dinamis">
      </div>
      <div class="text-center">
  ...
  <footer class="bg-warning text-center py-2">
    <div class="container">
      <p class="mb-0">&copy; Copyright @Luthfia Ryan Yumnaa Fauziy_117220060</p>
    </div>
  </footer>
